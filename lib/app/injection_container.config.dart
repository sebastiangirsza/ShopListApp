...
import '../data/remote_data_sources/svg_icon_remote_data_source.dart' as _i36;
import '../data/remote_data_sources/user_remote_data_source.dart' as _i38;
import 'cubit/auth_cubit.dart' as _i57;
...
import 'home/pages/recipes/cubit/recipes_cubit.dart' as _i60;
...
import 'home/pages/shop_list/cubit/product_cubit.dart' as _i58;
...
import 'repositories/svg_icon_repository.dart' as _i37;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i36.SvgIconRemoteDataSource>(
      () => _i36.SvgIconRemoteDataSource());
  gh.factory<_i37.SvgIconRepository>(
      () => _i37.SvgIconRepository(get<_i36.SvgIconRemoteDataSource>()));
  ...
  gh.factory<_i50.SvgIconCubit>(
      () => _i50.SvgIconCubit(get<_i37.SvgIconRepository>()));
  ...
  gh.factory<_i53.AddProductPriceCubit>(
      () => _i53.AddProductPriceCubit(get<_i43.ProductPriceRepository>()));
  gh.factory<_i54.AddRecipesCubit>(() => _i54.AddRecipesCubit(
        get<_i47.RecipesRepository>(),
        get<_i39.UserRespository>(),
        get<_i35.StorageRepository>(),
      ));
  gh.factory<_i55.AddShopCubit>(() => _i55.AddShopCubit(
        get<_i39.UserRespository>(),
  ...
  gh.factory<_i58.ProductCubit>(
      () => _i58.ProductCubit(get<_i44.ProductsRepository>()));
  gh.factory<_i59.ProductPriceCubit>(
      () => _i59.ProductPriceCubit(get<_i43.ProductPriceRepository>()));
  gh.factory<_i60.RecipesCubit>(() => _i60.RecipesCubit(
        get<_i47.RecipesRepository>(),
        get<_i39.UserRespository>(),
        get<_i34.StorageRemoteDataSource>(),
      ));
