...
import '../data/remote_data_sources/product_price_remote_data_source.dart'
    as _i23;
import '../data/remote_data_sources/product_remote_data_source.dart' as _i24;
...
import '../data/remote_data_sources/user_remote_data_source.dart' as _i34;
import 'cubit/auth_cubit.dart' as _i52;
import 'cubit/verification_cubit.dart' as _i36;
...
import 'home/pages/price/add_shop/cubit/add_shop_cubit.dart' as _i50;
import 'home/pages/price/add_shop_products/add_shop_products_page.dart' as _i9;
...
import 'home/pages/price/product_price/cubit/product_price_cubit.dart' as _i54;
import 'home/pages/price/product_price/product_price_page.dart' as _i22;
import 'home/pages/price/shop/cubit/shop_cubit.dart' as _i56;
import 'home/pages/price/shop/shop_page.dart' as _i29;
import 'home/pages/price/shop_products/cubit/shop_products_cubit.dart' as _i57;
import 'home/pages/recipes/cubit/recipes_cubit.dart' as _i55;
...
import 'home/pages/shop_list/cubit/add_product_cubit.dart' as _i47;
import 'home/pages/shop_list/cubit/product_cubit.dart' as _i53;
...
import 'home/pages/shop_list/shop_list/list_of_product_group_widget.dart'
    as _i19;
import 'home/pages/your_products/cubit/purchased_products_cubit.dart' as _i46;
...
import 'repositories/firebase_auth_repository.dart' as _i37;
import 'repositories/items_repository.dart' as _i38;
import 'repositories/product_price_repository.dart' as _i39;
import 'repositories/product_repository.dart' as _i40;
import 'repositories/purchased_products_repository.dart' as _i41;
import 'repositories/recipes_products_repository.dart' as _i42;
import 'repositories/recipes_repository.dart' as _i43;
import 'repositories/shop_products_repository.dart' as _i44;
import 'repositories/shop_repository.dart' as _i45;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i9.AddShopProductsPage>(
      () => _i9.AddShopProductsPage(key: get<_i4.Key>()));
  ...
  gh.factory<_i22.ProductPricePage>(
      () => _i22.ProductPricePage(key: get<_i4.Key>()));
  gh.factory<_i23.ProductPriceRemoteDataSource>(
      () => _i23.ProductPriceRemoteDataSource());
  gh.factory<_i24.ProductRemoteDataSource>(
      () => _i24.ProductRemoteDataSource());
  ...
  gh.factory<_i34.UserRemoteDataSource>(() => _i34.UserRemoteDataSource());
  gh.factory<_i35.UserRespository>(
      () => _i35.UserRespository(get<_i34.UserRemoteDataSource>()));
  gh.factory<_i36.VerificationCubit>(
      () => _i36.VerificationCubit(get<_i34.UserRemoteDataSource>()));
  gh.factory<_i37.FirebaseAuthRespository>(
      () => _i37.FirebaseAuthRespository(get<_i34.UserRemoteDataSource>()));
  gh.factory<_i38.ItemsRepository>(() => _i38.ItemsRepository(
        get<_i18.ItemsRemoteDataSource>(),
        get<_i34.UserRemoteDataSource>(),
      ));
  gh.factory<_i39.ProductPriceRepository>(() => _i39.ProductPriceRepository(
        get<_i23.ProductPriceRemoteDataSource>(),
        get<_i34.UserRemoteDataSource>(),
      ));
  gh.factory<_i40.ProductsRepository>(() => _i40.ProductsRepository(
        get<_i24.ProductRemoteDataSource>(),
        get<_i34.UserRemoteDataSource>(),
      ));
  gh.factory<_i41.PurchasedProductsRepository>(
      () => _i41.PurchasedProductsRepository(
            get<_i25.PurchasedProductsRemoteDataSource>(),
            get<_i34.UserRemoteDataSource>(),
          ));
  gh.factory<_i42.RecipesProductsRepository>(
      () => _i42.RecipesProductsRepository(
            get<_i26.RecipesProductRemoteDataSource>(),
            get<_i34.UserRemoteDataSource>(),
          ));
  gh.factory<_i43.RecipesRepository>(() => _i43.RecipesRepository(
        get<_i27.RecipesRemoteDataSource>(),
        get<_i34.UserRemoteDataSource>(),
      ));
  gh.factory<_i44.ShopProductsRepository>(() => _i44.ShopProductsRepository(
        get<_i30.ShopProductsRemoteDataSource>(),
        get<_i34.UserRemoteDataSource>(),
      ));
  gh.factory<_i45.ShopRepository>(() => _i45.ShopRepository(
        get<_i31.ShopRemoteDataSource>(),
        get<_i34.UserRemoteDataSource>(),
      ));
  gh.factory<_i46.YourProductsCubit>(
      () => _i46.YourProductsCubit(get<_i41.PurchasedProductsRepository>()));
  gh.factory<_i47.AddProductCubit>(
      () => _i47.AddProductCubit(get<_i40.ProductsRepository>()));
  gh.factory<_i48.AddProductPriceCubit>(
      () => _i48.AddProductPriceCubit(get<_i39.ProductPriceRepository>()));
  gh.factory<_i49.AddRecipesCubit>(() => _i49.AddRecipesCubit(
        get<_i43.RecipesRepository>(),
        get<_i35.UserRespository>(),
        get<_i33.StorageRepository>(),
      ));
  gh.factory<_i50.AddShopCubit>(() => _i50.AddShopCubit(
        get<_i35.UserRespository>(),
        get<_i32.StorageRemoteDataSource>(),
        get<_i33.StorageRepository>(),
        get<_i45.ShopRepository>(),
      ));
  gh.factory<_i51.AddShopProductsCubit>(() => _i51.AddShopProductsCubit(
        get<_i35.UserRespository>(),
        get<_i32.StorageRemoteDataSource>(),
        get<_i33.StorageRepository>(),
        get<_i44.ShopProductsRepository>(),
      ));
  gh.factory<_i52.AuthCubit>(() => _i52.AuthCubit(
        get<_i37.FirebaseAuthRespository>(),
        get<_i34.UserRemoteDataSource>(),
      ));
  gh.factory<_i53.ProductCubit>(
      () => _i53.ProductCubit(get<_i40.ProductsRepository>()));
  gh.factory<_i54.ProductPriceCubit>(
      () => _i54.ProductPriceCubit(get<_i39.ProductPriceRepository>()));
  gh.factory<_i55.RecipesCubit>(() => _i55.RecipesCubit(
        get<_i43.RecipesRepository>(),
        get<_i35.UserRespository>(),
        get<_i32.StorageRemoteDataSource>(),
      ));
  gh.factory<_i56.ShopCubit>(() => _i56.ShopCubit(get<_i45.ShopRepository>()));
  gh.factory<_i57.ShopProductsCubit>(
      () => _i57.ShopProductsCubit(get<_i44.ShopProductsRepository>()));
  return get;
}
